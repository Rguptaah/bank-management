      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item active" style="background-image: url(assets/img/slide/slide-1.jpg)">
          <div class="carousel-container">
            <div class="container">
              <h2 class="animate__animated animate__fadeInDown">Welcome to <span><?php echo $inst_name; ?> </span></h2>
              <p class="animate__animated animate__fadeInUp">Live as if you were to die tomorrow. Learn as if you were to live forever. </p>
              <a href="#about" class="btn-get-started animate__animated animate__fadeInUp scrollto">Mahatma Gandhi</a>
            </div>
          </div>
        </div>
        ...
        <div class="carousel-item" style="background-image: url(assets/img/slide/slide-2.jpg)">
          <div class="carousel-container">
            <div class="container">
              ...
              <p class="animate__animated animate__fadeInUp">The difference between a successful person and others is not a lack of strength, not a lack of knowledge, but rather a lack in will. </p>
       ...
       <div class="container">
			...
			<div class="col-lg-6">
				...
				<div class="form-group row">
				  ...
				  <div class="col-sm-8">
					<input class="form-control" type="number"  value='<?php echo $student_mobile;?>' pattern="[6789][0-9]{9}" name="student_mobile" required>
				  </div>
				</div>
				...
				<div class="form-group row">
				  <label for="example-text-input" class="col-sm-4 col-form-label">Form Fee</label>
				  <div class="col-sm-8">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-5 d-flex align-items-stretch">
            <div class="info">
              <div class="address">
                ...
                <h4>Location:</h4>
                <p><?php echo $inst_address1. $inst_addess2; ?> </p>
              </div>

              <div class="email">
                <i class="bi bi-envelope"></i>
                <h4>Email:</h4>
                 <p><a href='mailto:<?php echo $inst_email; ?>'><?php echo $inst_email; ?></a></p>
              </div>

              <div class="phone">
                <i class="bi bi-phone"></i>
                <h4>Call:</h4>
                <p><a href='tel<?php echo $inst_contact; ?>'><?php echo $inst_contact; ?></a></p>
              </div>
          ...
          <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
            <form action="../master_process?task=update_enquiry" method="post" role="form" class="php-email-form">
              <div class="row">
